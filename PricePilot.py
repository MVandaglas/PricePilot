...
def handle_gpt_chat():
    if customer_input:
        ...
        for line in lines:
            ...
            # Zoek naar artikelnummer en m2 (patroon zoals 6-6 of 400m2)
            ...
            if m2_match:
                ...
                if description:
                    ...
                    data.append([
                        ...
                        f"{recommended_price:.2f}" if recommended_price else 0, None,
                        f"{m2_total:.2f}", None, None, min_price, max_price,
                ...
                # Haal hoeveelheid, breedte, hoogte en artikelnummer uit de regel
                ...
                # Debug: toon fallback artikelnummer
