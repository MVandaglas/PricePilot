...
gb.configure_column("Prijs_backend", hide=False, columnGroup="Pricing",)
gb.configure_column("Min_prijs", hide=True)
gb.configure_column("Artikelnummer", hide=False, columnGroup="Basisinfo",)
gb.configure_column("Prijskwaliteit", hide=True)
gb.configure_column("Max_prijs", hide=True)
gb.configure_column("Breedte", editable=True, type=["numericColumn"], columnGroup="Afmetingen",)
gb.configure_column("Hoogte", editable=True, type=["numericColumn"], columnGroup="Afmetingen",)
gb.configure_column("Aantal", editable=True, type=["numericColumn"], columnGroup="Basisinfo",)
gb.configure_column("RSP", editable=False, type=["numericColumn"], valueFormatter="x.toFixed(2)", cellStyle=cell_style_js, columnGroup="Pricing")
gb.configure_column("Verkoopprijs", editable=False, type=["numericColumn"], cellStyle=cell_style_js, valueFormatter="x.toFixed(2)", columnGroup="Pricing")
gb.configure_column("Handmatige prijs", editable=True, type=["numericColumn"], columnGroup="Pricing")
gb.configure_column("M2 p/s", editable=False, type=["numericColumn"], cellStyle={"backgroundColor": "#e0e0e0"}, valueFormatter="x.toFixed(2)", columnGroup="Afmetingen")
gb.configure_column("M2 totaal", editable=False, type=["numericColumn"], cellStyle={"backgroundColor": "#e0e0e0"}, valueFormatter="x.toFixed(2)", columnGroup="Afmetingen")
gb.configure_column("SAP Prijs", editable=False, type=["numericColumn"], valueFormatter="x.toFixed(2)", cellStyle=cell_style_js, columnGroup="Pricing")
gb.configure_column("Source", hide=False)
gb.configure_column("Prijsoorsprong",hide=False, editable=False, columnGroup="Pricing")
